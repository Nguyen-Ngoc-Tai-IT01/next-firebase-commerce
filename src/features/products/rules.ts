...
export const AddProductSchema = z.object({
    ...
    createdId: z.string() // Giữ nguyên schema gốc này cho model.ts
...
// 🔥 TẠO SCHEMA MỚI CHO FORM (loại bỏ createdId)
export const AddProductFormSchema = AddProductSchema.omit({ createdId: true });
